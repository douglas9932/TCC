...
begin
  ...
  if DBLookupComboBox1.Text='' Then
    begin
      messageDLG('Escolha Um Funcionário',mtInformation,[mbok],0);
  ...
  if DM.TBDescarteQTD.AsInteger<=0 then
    ...
    begin
      MessageDlg('A Descrição Não Deve Estar Em Branco',
      mtInformation,[mbok],0);
      DbEdit1.SetFocus;
      Exit;
    ...
    begin
      MessageDlg('Quantidade Não Deve Estar Em Branco',
      mtInformation,[mbok],0);
      DbEdit6.SetFocus;
      Exit;
    ...
    begin
      MessageDlg('Quantidade Descartada Não Pode Ser Maior Que Do Estoque',
      mtInformation,[mbok],0);
      DbEdit6.SetFocus;
      Exit;
