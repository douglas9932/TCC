...
begin
    ...
    DM.TBCompra.Edit; //permite alterar status e condição de pagamento
...
begin
 ...
 if DM.TBCompraSTATUSCOMPRA.AsString = 'CONF' then
    Begin
     Showmessage('Compra Já Confirmada Não Pode Ser Alterada');
     Abort;
    End
else
...
begin
 ...
 if DM.TBCompraSTATUSCOMPRA.AsString = 'CONF' then
  begin
  Showmessage('Compra Confirmada Não Pode Ser Alterada');
  Abort;
  end
  else
...
begin
 ...
 if DBLookupComboBox1.Text = '' then
   begin
   Showmessage('Informe O Nome Do Funcionário Para Realizar A Compra');
