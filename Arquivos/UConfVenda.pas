...
begin
          ...
          While not EOF do
            begin;
              ...
              if (DM.TBProdutoQUANTIDADE.AsFloat-
                ...
                begin
                  MessageDLG('Não Há Produto Suficiente Para Realizar A Venda'+#13
 ...
 DM.TBProduto.Refresh;
    ...
    if DM.TBVendaTIPO.AsString = 'À VISTA' then
    begin
    DM.TBContasAReceberDATAVENCIMENTO.AsDateTime:=Date;
    end;
    ...
    DM.TBContasAReceberTIPO.AsString:= 'À VISTA';
    ...
    DM.TBCaixaVALORENTRADA.AsFloat:= DM.TBCaixaVALORENTRADA.AsFloat + DM.TBRecebimentoVALORDACONTA.AsFloat;

    DM.TBCaixaSALDO.AsFloat:=  DM.TBCaixaSALDO.AsFloat + DM.TBRecebimentoVALORDACONTA.Asfloat;
