...
begin
    ...
    Begin
      Showmessage('Não Há Saldo No Caixa');
      Abort;
    End
    ...
    if DM.TBCompraTIPO.AsString = 'À VISTA' then
    begin
    DM.TBContasAPagarDATAVENCIMENTO.AsDateTime:=Date;
    end;

    DM.TBContasAPagarDESCRICAO.AsString:= 'Conta À Receber De Compra';
    ...
    DM.TBContasAPagarTIPO.AsString:= 'À VISTA';
